...
public class VersionChecker : Attribute
{
    ...
    public static bool CheckEftVersion(ManualLogSource Logger, PluginInfo Info, ConfigFile Config = null)
    {
        ...
        {
            string errorMessage = $"ERROR: This version of Quests Extended was built for Tarkov {buildVersion}, but you are running {currentVersion}. Please download the correct plugin version.";
